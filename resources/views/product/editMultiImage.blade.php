...
<div class="row">
  <div class=" col-lg-12">
    <div class="card radius-15 border-lg-top-info">
      ...
      <div class="card-body">
        <form action="{{ route('admin.products.update.multi-image') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="form-body">
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <a href="{{ route('admin.products.update.multi-image.delete',$multiImage->id) }}" class="btn btn-sm btn-block btn-danger delete-confirm1" type="submit" data-toggle="tooltip" title="Delete &#128683">
...
<div class="row">
  <div class=" col-lg-12">
    <div class="card radius-15 border-lg-top-info">
      ...
      <div class="card-body">
        <form action="{{ route('admin.products.store.multiImage') }}" method="POST" enctype="multipart/form-data">
          @csrf
